...
# All rights reserved.
#
# This file is part of the NPOESS High-Level HDF5 APIs.  The full copyright 
...
# "the NPOESS High-Level HDF5 APIs copyright and license statement" from 
# help@hdfgroup.org.
# 
##############################################################################
#! /bin/sh
...
topics="ex_bitfield ex_lite_copy_region ex_lite_read_region ex_regref_copy_references ex_regref_create ex_regref_read ex_ref_to_all ex_GMGTO"
...
do
    fname=$topic
    $ECHO_N "Testing examples/$fname...$ECHO_C"
...
rm -f tmp.test
echo "$return_val tests failed in examples"
exit $return_val
